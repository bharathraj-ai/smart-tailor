      ...
      <div className="container">
        <div className={styles.contactGrid}>
          ...
          <div className={styles.infoSection}>
            ...
            <div className={`card ${styles.infoCard}`}>
              <div className={styles.infoIconWrapper} style={{ background: 'rgba(255, 0, 0, 0.1)', color: '#FF0000' }}>
              ...
              <div className={styles.infoContent}>
                <h3>YouTube</h3>
                <p><a href="https://youtube.com/@ajaytailorchanneltamil?si=rKJBrekblUCiQS5O" target="_blank" rel="noopener noreferrer">Ajay Tailor Channel Tamil</a></p>
              </div>
            </div>

            <div className={`card ${styles.infoCard}`}>
              <div className={styles.infoIconWrapper} style={{ background: 'rgba(225, 48, 108, 0.1)', color: '#E1306C' }}>
              ...
              <div className={styles.infoContent}>
                <h3>Instagram</h3>
                <p><a href="https://www.instagram.com/ajay_tailor_chanel_offocial_?igsh=a3c1Z2lvYjM5cmc0" target="_blank" rel="noopener noreferrer">@ajay_tailor_chanel_offocial_</a></p>
              </div>
            </div>
          </div>
        </div>
